...
class Rectangle(Base):
    ...
    @property
    def x(self):
        """Returns the value of __x"""
        return self.__x

    @x.setter
    def x(self, value):
        """Defines the value of __x"""
        if not isinstance(value, int):
    ...
    @property
    def y(self):
        """Returns the value of __y"""
        return self.__y

    @y.setter
    def y(self, value):
        """Defines the value of __y"""
        if not isinstance(value, int):
    ...
    def display(self):
        ...
        for _ in range(self.__height):
            str_repr += " " * self.__x + '#' * self.__width + '\n'
        print(str_repr, end='')
